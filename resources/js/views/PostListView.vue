...
<template>
    <div class="space-y-4">
        ...
        <div class="rounded-lg bg-white dark:bg-gray-800 shadow p-4 grid grid-cols-2 sm:grid-cols-6 gap-3">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    ...
                    <tr v-if="!posts.length">
                        <td colspan="7" class="px-4 py-6 text-center text-gray-400">尚無符合條件的文章</td>
                    </tr>
                </tbody>
            </table>
